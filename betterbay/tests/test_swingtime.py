...
from betterbay import utils
from betterbay import models
from betterbay import forms
...
class TestNewEventForm:
    ...
    def test_new_event_simple(self, play_type):
        ...
        evt_form = forms.EventForm(data)
        occ_form = forms.MultipleOccurrenceForm(data)
